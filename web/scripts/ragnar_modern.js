...
async function preloadAllTabs() {
    ...
    try {
        ...
        await Promise.all([
            ...
            // loadImagesData() - Removed to save memory
...
// Image Gallery removed to reduce memory usage on Pi Zero W2
...
// Image Management Functions - REMOVED (memory optimization for Pi Zero W2)
